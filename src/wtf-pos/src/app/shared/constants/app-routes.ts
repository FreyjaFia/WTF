export const AppRoutes = {
  ...
  InventoryItemDetailsById: (inventoryItemId: string) => `/inventory/items/details/${inventoryItemId}`,
  InventoryItemsEditById: (inventoryItemId: string) => `/inventory/items/edit/${inventoryItemId}`,
